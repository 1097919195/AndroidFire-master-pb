 ...
 */
public class MDAlertDialog2 implements View.OnClickListener {
    ...
    private ImageView mExit;//关闭按钮
    private TextView mTxt1;
    private TextView mTxt2;
    private TextView mTxt3;

    public MDAlertDialog2(Builder builder) {

        mBuilder = builder;
        mDialog = new Dialog(mContext, R.style.MyDialogStyle);
        mDialogView = View.inflate(mContext, R.layout.widget_md_dialog2, null);
        ...
        mExit= (ImageView) mDialogView.findViewById(R.id.md_dialog_exit);
        mTxt1= (TextView) mDialogView.findViewById(R.id.md_dialog_txt1);
        mTxt2= (TextView) mDialogView.findViewById(R.id.md_dialog_txt2);
        mTxt3= (TextView) mDialogView.findViewById(R.id.md_dialog_txt3);
    ...
    private void initDialog() {
        ...
        mTxt1.setText(mBuilder.getStringtxt1());
        mTxt2.setText(mBuilder.getStringtxt2());
        mTxt3.setText(mBuilder.getStringtxt3());
    ...
    public static class Builder {
        ...
        public String getStringtxt1() {
            return stringtxt1;
        }

        public Builder setStringtxt1(String stringtxt1) {
            this.stringtxt1 = stringtxt1;
            return this;
        }

        public String getStringtxt2() {
            return stringtxt2;
        }

        public Builder setStringtxt2(String stringtxt2) {
            this.stringtxt2 = stringtxt2;
            return this;
        }

        public String getStringtxt3() {
            return stringtxt3;
        }

        public Builder setStringtxt3(String stringtxt3) {
            this.stringtxt3 = stringtxt3;
            return this;
        }
        ...
        public MDAlertDialog2 build() {

            return new MDAlertDialog2(this);
        }
    }
